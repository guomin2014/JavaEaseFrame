...
public final class EntityUtil {
    ...
    public static final Map entityToMapByApache(Object entity, Map map) {
        try {
            Map temp = BeanUtils.describe(entity);
            temp.forEach((key, value) -> {
                if (value != null) {
                    String propertyName = key.toString();
                    if (!propertyName.equals("class") 
                            && !propertyName.equals("orderCols") 
                            && !propertyName.equals("notSelectCols") 
                            && !propertyName.equals("symbolCols")
    ...
    public static final <T> T mapToEntityByApache(Map map, T entity) {
        try {
