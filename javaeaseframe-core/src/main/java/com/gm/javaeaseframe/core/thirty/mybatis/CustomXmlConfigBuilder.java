...
public class CustomXmlConfigBuilder extends BaseBuilder {
    ...
    public CustomXmlConfigBuilder(InputStream inputStream, Configuration configuration) {
        super(configuration);
    ...
    private void settingsElement(XNode context) throws Exception {
        if (context != null) {
            ...
            configuration.setAutoMappingBehavior(AutoMappingBehavior.valueOf(StringUtils.defaultIfEmpty(props.getProperty("autoMappingBehavior"), "PARTIAL")));
            ...
            configuration.setDefaultExecutorType(ExecutorType.valueOf(StringUtils.defaultIfEmpty(props.getProperty("defaultExecutorType"), "SIMPLE")));
            configuration.setDefaultStatementTimeout(integerValueOf(props.getProperty("defaultStatementTimeout"), null));
            configuration.setMapUnderscoreToCamelCase(booleanValueOf(props.getProperty("mapUnderscoreToCamelCase"), false));
            configuration.setSafeRowBoundsEnabled(booleanValueOf(props.getProperty("safeRowBoundsEnabled"), false));
            configuration.setLocalCacheScope(LocalCacheScope.valueOf(StringUtils.defaultIfEmpty(props.getProperty("localCacheScope"), "SESSION")));
            configuration.setJdbcTypeForNull(JdbcType.valueOf(StringUtils.defaultIfEmpty(props.getProperty("jdbcTypeForNull"), "OTHER")));
