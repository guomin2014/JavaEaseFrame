...
public abstract class BaseCRUDController<TS extends ICRUDService<T, PK>, TF extends BaseCRUDForm<T, PK>, T extends BaseEntity<PK>, PK extends Serializable> extends BaseController {
...
//        setFormState(request, formState);
    ...
    protected final Object newCommandObject(Class clazz) throws Exception {
        ...
        } else if (this.isEqual(clazz.getName(), BaseCRUDForm.class.getName())) {
            // 获取当前实例的泛型的真实类类型
