...
import com.gm.javaeaseframe.knife4j.spring.boot.autoconfigure.properties.CustomKnife4jAuthInfoProperties;
import com.gm.javaeaseframe.knife4j.spring.boot.autoconfigure.properties.CustomKnife4jHttpBasic;
import com.gm.javaeaseframe.knife4j.spring.boot.autoconfigure.properties.CustomKnife4jInfoProperties;
import com.gm.javaeaseframe.knife4j.spring.boot.autoconfigure.properties.CustomKnife4jProperties;
import com.gm.javaeaseframe.knife4j.spring.boot.autoconfigure.properties.CustomKnife4jSetting;
...
@EnableConfigurationProperties({CustomKnife4jProperties.class, CustomKnife4jInfoProperties.class, CustomKnife4jHttpBasic.class, CustomKnife4jSetting.class, CustomKnife4jAuthInfoProperties.class})
@ConditionalOnProperty(name = PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.enable", havingValue = "true")
public class Knife4jAutoConfiguration {
	...
	@ConditionalOnProperty(name = PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.cors", havingValue = "true")
	...
	@ConditionalOnProperty(name = PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.basic.enable", havingValue = "true")
	public ServletSecurityBasicAuthFilter securityBasicAuthFilter(Knife4jProperties knife4jProperties) {
		...
		if (knife4jProperties == null) {
			authFilter.setEnableBasicAuth(EnvironmentUtils.resolveBool(environment, PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.basic.enable", Boolean.FALSE));
			authFilter.setUserName(EnvironmentUtils.resolveString(environment, PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.basic.username", GlobalConstants.BASIC_DEFAULT_USERNAME));
			authFilter.setPassword(EnvironmentUtils.resolveString(environment, PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.basic.password", GlobalConstants.BASIC_DEFAULT_PASSWORD));
		} else {
			// 判断非空
	...
	@ConditionalOnProperty(name = PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.production", havingValue = "true")
	public ProductionSecurityFilter productionSecurityFilter(Knife4jProperties knife4jProperties) {
		...
		if (setting == null) {
			int customCode = EnvironmentUtils.resolveInt(environment, PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.setting.custom-code", 200);
			boolean prod = EnvironmentUtils.resolveBool(environment, PlatformConstants.PLATFORM_CONFIG_PREFIX + ".knife4j.production", Boolean.FALSE);
    ...
    public class CustomKnife4jEnhanceAutoConfiguration {
