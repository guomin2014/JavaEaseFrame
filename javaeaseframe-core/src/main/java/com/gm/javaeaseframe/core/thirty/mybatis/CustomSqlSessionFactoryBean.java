 ...
 * @see #setDataSource
 * @version $Id: SqlSessionFactoryBean.java 4549 2012-01-08 05:23:20Z
 *          eduardo.macarron $
 */
public class CustomSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        if (StringUtils.hasLength(this.typeAliasesPackage)) {
            String[] typeAliasPackageArray = StringUtils.tokenizeToStringArray(this.typeAliasesPackage, ConfigurableApplicationContext.CONFIG_LOCATION_DELIMITERS);
        ...
        if (StringUtils.hasLength(this.typeHandlersPackage)) {
            String[] typeHandlersPackageArray = StringUtils.tokenizeToStringArray(this.typeHandlersPackage, ConfigurableApplicationContext.CONFIG_LOCATION_DELIMITERS);
        ...
        if (configLocations != null) {
            for (Resource configLocationTmp : configLocations) {
                CustomXmlConfigBuilder xmlConfig = new CustomXmlConfigBuilder(configLocationTmp.getInputStream(), configuration);
                xmlConfig.parse();
            }
        }
